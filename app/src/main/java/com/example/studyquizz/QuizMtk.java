...
public class QuizMtk extends AppCompatActivity {
    ...
    Question[] questions = {
            ...
            new Question("1. Diketahui: barisan aritmatika 2,5,8, …, lalu jumlah 10 suku pertama barisan aritmatika tersebut adalah ….",
                    "A. 155",
                    "B. 156",
                    "C. 157 ",
                    "D. 166 ",
            ...
            new Question("2. Pernyataan berikut tentang nilai mutlak yang paling tepat adalah ….",
                    "A. |-5|=5",
                    "B. |-5|=-5",
                    "C. |5|=-5",
                    "D. |5|=25",
            ...
            new Question("3. Himpunan penyelesaian dari |3x|+1=7 adalah ….",
            ...
            new Question("4. Hasil kali dari himpunan penyelesaian persamaan kuadrat x^2 - 4x +4 adalah",
            ...
            new Question("5. Hasil kali f(x) = 2x^4 dan g(x) 3x^2 adalah...",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizmtkCompleted = sharedPreferences.getBoolean("quizmtkCompleted", false);

        if (quizmtkCompleted) {
            Intent intent = new Intent(QuizMtk.this, MenuMahasiswa.class);
            Toast.makeText(QuizMtk.this, "Anda Telah Melakukan Quiz", Toast.LENGTH_SHORT).show();
    ...
    private void finishQuiz() {
        ...
        editor.putInt("quizmtk", score);
        editor.putBoolean("quizmtkCompleted", true);
        editor.apply();
