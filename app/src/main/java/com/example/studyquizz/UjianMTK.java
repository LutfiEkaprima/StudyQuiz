...
public class UjianMTK extends AppCompatActivity {
    ...
    Question[] questions = {
            ...
            new Question("1. Diberikan suku banyak P(x) = 2x^3 - 3x + 1. Nilai suku banyak untuk x=3 adalah ….",
                    "A. 30",
                    "B. 36",
                    "C. 46",
                    "D. 50 ",
            ...
            new Question("2. Hasil kali f(x) = 2x^3 - 4x - 1 dan g(x) = -4x^2 + 2x^2 adalah …. ",
                    "A. -2x^7 + 8x^5 + x^4 - 8x^3 - 2x^2",
                    "B.  x^7 + 8x^6 + x^4 - 8x^3 - 2x^2",
                    "C.  -2x^7 + 8x^5 + x^4 - 8x^3 + 2x^2 ",
                    "D.  3x^5 + x^4 - 8x^3 - 2x^2",
                    "A. -2x^7 + 8x^5 + x^4 - 8x^3 - 2x^2",
                    0),

            new Question("3. Jika salah satu akar persamaan hx^2 + 5x - 12 = 0 , adalah 2, maka akar yang lain adalah ….",
                    "A. -12 ",
                    "B. -1",
                    "C. 3 ",
                    "D. 4 ",
            ...
            new Question("4. Hasil kali dari himpunan penyelesaian persamaan kuadrat -x^2 + 6x -8 = 0 adalah …. ",
                    "A. 8",
                    "B. 6 ",
                    "C. -8",
                    "D. 6 ",
            ...
            new Question("5. Rumus suku ke-n yang menyatakan pola bilangan 4, 7, 10, 13, … adalah …. ",
                    "A. Un = 3n+1",
                    "B. Un = 3n+2 ",
                    "C. Un = 4n+1",
                    "D. Un = 5n+1",
    ...
    private boolean ujianmtkCompleted;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ujianmtkCompleted = sharedPreferences.getBoolean("ujianmtkCompleted", false);

        if (ujianmtkCompleted) {
            Intent intent = new Intent(UjianMTK.this, MenuMahasiswa.class);
            Toast.makeText(UjianMTK.this, "Anda Telah Melakukan Ujian", Toast.LENGTH_SHORT).show();
    ...
    private void finishQuiz() {
        ...
        editor.putInt("ujianmtk", score);
        editor.putBoolean("ujianmtkCompleted", true);
        editor.apply();
