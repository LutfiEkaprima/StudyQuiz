...
public class UjianPBO extends AppCompatActivity {
    ...
    Question[] questions = {
            ...
            new Question("1. Fungsi method System.in dalam java adalah…",
                    "A. Mengirimkan keluaran ke layar ",
                    "B. Menampilkan pesan kesalahan",
                    "C. Menangani pembacaan dari keyboard ",
                    "D. Menangani suatu objek ",
                    "C. Menangani pembacaan dari keyboard ",
                    0),

            new Question("2. Class yang mempunyai sedikitnya satu abstract metode disebut ... ",
                    "A. Abstract class",
                    "B. Class",
            ...
            new Question("3. Arsitektur java yang dipakai untuk wireless device / mobile device, disebut dengan… . . ",
                    "A. J2EF ",
                    "B. J2EM ",
                    "C. J2ME ",
                    "D. J2SE ",
            ...
            new Question("4. Istilah untuk melindungi data dari usaha modofikasi, perusakan dan penggandaan data oleh pihak yang tidak berwenang adalah ...",
                    "A. Inheritance",
                    "B. Polymorphisme ",
                    "C. Constructor",
                    "D. Encapsulation ",
            ...
            new Question("5. Suatu method yang dapat dijalankan otomatis pada saat object dari class dibuat, dikenal dengan ... ",
                    "A. Inheritance ",
                    "B. Garbage Collector ",
                    "C. Initializer ",
                    "D. Constructor ",
    ...
    private boolean ujianpboCompleted;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ujianpboCompleted = sharedPreferences.getBoolean("ujianpboCompleted", false);

        if (ujianpboCompleted) {
            Intent intent = new Intent(UjianPBO.this, MenuMahasiswa.class);
            Toast.makeText(UjianPBO.this, "Anda Telah Melakukan Ujian", Toast.LENGTH_SHORT).show();
    ...
    private void finishQuiz() {
        ...
        editor.putInt("ujianpbo", score);
        editor.putBoolean("ujianpboCompleted", true);
        editor.apply();
