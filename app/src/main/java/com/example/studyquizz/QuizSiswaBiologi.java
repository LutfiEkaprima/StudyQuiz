...
public class QuizSiswaBiologi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizbiologi = sharedPreferences.getBoolean("quizbiologi", false);

        if (quizbiologi) {
            Intent intent = new Intent(QuizSiswaBiologi.this, Menu.class);
            Toast.makeText(QuizSiswaBiologi.this, "Anda Telah Melakukan Quiz", Toast.LENGTH_SHORT).show();
    ...
    private void finishQuiz() {
        ...
        editor.putInt("nilaiquizbiologi", score);
        editor.putBoolean("quizbiologi", true);
        editor.apply();

        Intent intent = new Intent(QuizSiswaBiologi    .this, LihatJawabanActivity.class);
