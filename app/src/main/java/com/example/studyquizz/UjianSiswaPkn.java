...
public class UjianSiswaPkn extends AppCompatActivity {
    ...
    Question[] questions = {
            ...
            new Question("1. Apa yang dimaksud dengan demokrasi?",
                    "A. Sistem pemerintahan oleh satu individu",
                    "B. Sistem pemerintahan oleh sekelompok elit",
                    "C. Sistem pemerintahan oleh rakyat",
                    "D. Sistem pemerintahan oleh agama",
                    "C. Sistem pemerintahan oleh rakyat",
                    0),

            new Question("2. Siapa presiden pertama Indonesia?",
                    "A. Soekarno",
                    "B. Soeharto",
                    "C. BJ Habibie",
            ...
            new Question("3. Apa fungsi Mahkamah Konstitusi?",
                    "A. Mengawasi pelaksanaan pemilu",
                    "B. Mengadili sengketa pemilu",
                    "C. Mengawasi pelaksanaan pemerintahan",
                    "D. Mengadili tindak pidana korupsi",
                    "B. Mengadili sengketa pemilu",
                    0),

            new Question("4. Apa yang dimaksud dengan Trias Politika?",
                    "A. Pembagian kekuasaan menjadi tiga lembaga pemerintahan",
                    "B. Pemisahan agama dan negara",
                    "C. Sistem pemerintahan oleh rakyat",
                    "D. Sistem pemerintahan oleh partai politik",
                    "A. Pembagian kekuasaan menjadi tiga lembaga pemerintahan",
                    0),

            new Question("5. Apa yang diatur dalam Undang-Undang Dasar 1945?",
                    "A. Hak asasi manusia",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ujianpkn = sharedPreferences.getBoolean("ujianpkn", false);

        if (ujianpkn) {
            Intent intent = new Intent(UjianSiswaPkn.this, Menu.class);
            Toast.makeText(UjianSiswaPkn.this, "Anda Telah Melakukan Ujian", Toast.LENGTH_SHORT).show();
    ...
    private void finishQuiz() {
        ...
        editor.putInt("nilaiujianpkn", score);
        editor.putBoolean("ujianpkn", true);
        editor.apply();
